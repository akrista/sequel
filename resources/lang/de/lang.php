...
return [
    ...
    /**
     * components/Pages/SequelError.vue
     */
    'error_page' => [
        'oops' => 'Oops...',
        'tried_connecting' => 'Verbindung hat nicht funktioniert.',
        'example_connection' => 'driver://user@host:port/database',
        'no_suggestions' => 'Sequel konnte keine Lösungsvorschläge machen.',
        'disabled' => 'Sequel wurde deaktiviert.',
    ],
    ...
    'table_status' => [
        ...
        'sequel_suggestions' => 'Sequel empfiehlt, noch einmal an folgenden Stellen nachzusehen:',
    ],
