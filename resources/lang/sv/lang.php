...
return [
    ...
    'error_page' => [
        ...
        'no_suggestions' => 'Sequel kunde inte föreslå några lösningar.',
        'disabled' => 'Sequel är avaktiverat.',
    ],
    ...
    'table_status' => [
        ...
        'sequel_suggestions' => 'Sequel föreslår att du ser över följande punktar',
    ],
